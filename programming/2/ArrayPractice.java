...
public class ArrayPractice
{
  ...
  */
  public static int[] buildIncreasingArray( int size, int startValue, int step )
  {
    ...
    System.out.print("buildIncreasingArray: ");
    printArray(data);
  ...
  */
  public static int[] buildRandomArray( int size, int maxValue )
  {
    ...
    System.out.print("buildRandomArray: ");
    printArray(data);
    /* YOUR BRILLIANT CODE HERE */
    return data;
  }
  ...
  */
  public static int firstOccurence( int[] data, int value )
  {
      ...
      if (data[i]==value){
        System.out.print("firstOccurence of 3 in array w/args 123453: " +i);
        break;
    } 
      /* YOUR BRILLIANT CODE HERE */
 // change this (it is just a placeholder to "get past" the compiler)
  }
    return i;
  }
  /**
  ...
  */
  public static int arraySum( int[] data )
  {
    ...
    System.out.print("arraySum for array w/args 123453: " + sum);
    /* YOUR BRILLIANT CODE HERE */
  ...
  */
  ...
  for(int i=0; i<data.length-1; i++){
    if(data[i]<data[i+1]){
      sorted=true;
    /* YOUR BRILLIANT CODE HERE */ // replace this
  } else{
      sorted=false;
  }
  }
    System.out.print("isSorted for array w/args 123453: " +sorted);
    return sorted;
  }
  /**
     Parameters:
  ...
  */
  public static int findMaxValue( int[] data ) {
    ...
    System.out.print("findMaxValue for array w/args 123453: " +max);
    return max;
  ...
  */
  public static int countOdds( int[] data ) {
    ...
    System.out.print("countOdds for array w/args 123453: " +count);
    return count;
  }
  /**
     Parameters:
  ...
  */
  ...
  {
    System.out.println("flip array w/args 123453:");
  ...
  public static void main( String[] args ){
    ...
    System.out.println();
    buildRandomArray (5,20);
    System.out.println();
    int[] numForArray = {1, 2, 3, 4, 5, 3};
    arraySum (numForArray);
    System.out.println();
    findMaxValue (numForArray);
    System.out.println();
    firstOccurence(numForArray,3);
    System.out.println();
    isSorted(numForArray);
    System.out.println();
    countOdds(numForArray);
    System.out.println();
    flip(numForArray);
